...
def pushToFiles():
    ...
    with open("C:\\Users\\Hayden\\PycharmProjects\\DataAcademyATMExam\\ATM_Exam\\src\\main\\filehandler\\data\\UserInfo.txt", 'r') as file:
        filedata = file.read()

    filedata = filedata.replace(getAccount("003")[2], getAccount("003")[2] + "\n")

    with open("C:\\Users\\Hayden\\PycharmProjects\\DataAcademyATMExam\\ATM_Exam\\src\\main\\filehandler\\data\\UserInfo.txt", "w") as file:
